...
// RegisterProductInfoHandlerServer registers the http handlers for server ProductInfo to "mux".
...
// RegisterProductInfoHandler registers the http handlers for server ProductInfo to "mux".
...
// RegisterProductInfoHandlerClient registers the http handlers for server ProductInfo
